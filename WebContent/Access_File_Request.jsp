...
<% 
	String query="select * from request where Status='Pending' and SendRequest='0' and Duration_Data='0'";
...
%>
 <TR>
              ...
              <TD> <a href="A_File_Response?filename=<%=resultset.getString(3)%>&user=<%=resultset.getString(2)%>&ownername=<%=resultset.getString(4)%>"><input type="button" name="sendkey" value="Accept" class="btn btn-primary"></a></TD>
              <TD> <a href="File_Reject?filename=<%=resultset.getString(3)%>&user=<%=resultset.getString(2)%>&ownername=<%=resultset.getString(4)%>"><input type="button" name="sendkey" value="Reject" class="btn btn-primary"></a></TD>
           </TR>
<% 
   } 
