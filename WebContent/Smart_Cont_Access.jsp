...
%>
	...
	<section class="container">
		...
		<% 
            ...
            ResultSet resultset =statement.executeQuery("select * from filerequest  where username='"+emailid+"' and Status='Accept' or Status='Request Accept'") ; 
        ...
        %>
           <TR>
               ...
               <TD> <a href="Show_Data.jsp?name=<%=resultset.getString(4)%>,<%=resultset.getString(3)%>"><button type="button" class="btn btn-info">Access Contracts</button></a></TD>
         <TD> <a href="NFile_Download.jsp?name=<%=resultset.getString(3)%>,<%=resultset.getString(4)%>,<%=resultset.getString(3)%>"><button type="button" class="btn btn-info">File Download</button></a></TD>
