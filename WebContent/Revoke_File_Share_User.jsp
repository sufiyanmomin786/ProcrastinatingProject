...
<header id="headO1">
	...
	<section class="container">
		<div class="heading">
			<!-- Heading -->
			<h2>Our Revoke File User Name</h2>
		</div>
		<div class="row">
			<div class="col-md-4">
		...
		<div class="panel-body">
						...
						<form action="RevokeFile" name="frm" method="post">
		...
		<% 
          ...
          int flag=0;
            ResultSet resultset =statement.executeQuery("select * from tblaccessnew where File_Name='"+Filename+"' and Owner_Email_ID='"+nm+"' ") ; 
        ...
        %>
           <TR>
               ...
               <TD> 	 <input type="checkbox" name="Checkbox"
										value="<%=resultset.getString(5)%>" /><b><%=resultset.getString(5)%>
</TD>
       ...
       {
       %>
       <tr><td><input type="submit" name="ok" value="Save" style="width:100px;"  ></td></tr>
       <%}
