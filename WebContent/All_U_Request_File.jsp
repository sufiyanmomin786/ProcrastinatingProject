...
<body>
	...
	<section class="container">
		...
		<% 
            ...
            ResultSet resultset =statement.executeQuery("select * from file_info  where role='"+role+"' and status_o='Pending' or status_o='0'") ; 
        ...
        %>
           <TR>
               ...
               <TD> <%= resultset.getString(3) %> </TD>
                <TD> <a href="A_File_Request?name=<%=resultset.getString(5)%>,<%=resultset.getString(3)%>,<%= resultset.getString(2) %>"><button type="button" class="btn btn-info">Request</button></a></TD>
