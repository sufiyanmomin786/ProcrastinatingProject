...
<% 
	String query="select * from request where Status='Pending' and RequestName='Key'";
...
%>
 <TR>
              ...
              <TD> <a href="File_Response?filename=<%=resultset.getString(3)%>&user=<%=resultset.getString(2)%>&ownername=<%=resultset.getString(4)%>"><input type="button" name="sendkey" value="Send Key" class="btn btn-primary"></a></TD>
